...
} as Meta<typeof FOnboardingStepper>;
...
const Template: StoryFn<typeof FOnboardingStepper> = (args, { argTypes }) => ({
	components: { FOnboardingStepper },
	props: Object.keys(argTypes),
	data() {
		return { currentStep: (args as Record<string, unknown>).value || 0 };
	},
