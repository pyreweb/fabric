              ...
              <div class="space-y-3">
                ...
                <template v-if="group.type === 'checkbox'">
                  <f-checkbox
                    ...
                    @change="handleCheckboxChange(group.name, option.value, $event)"
                  />
                </template>
                ...
                <template v-else-if="group.type === 'toggle'">
                  <f-toggle
                    ...
                    :disabled="option.disabled"
                    @input="handleToggleChange(group.name, option.value, $event)"
                  />
                </template>
...
export default {
  ...
  methods: {
    ...
    handleToggleChange(groupName, optionValue, checked) {
      ...
      this.$emit('filter-change', { group: groupName, option: optionValue, value: checked })
    },
    /**
     * Handle input change
     */
    handleInputChange(groupName, optionValue, value) {
      ...
      this.$emit('filter-change', { group: groupName, option: optionValue, value })
    },
    /**
