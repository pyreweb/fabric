	...
	data() {
		return {
			icons: [
				...
				'check', 'x', 'plus', 'minus', 'search', 'menu', 'close', 'refresh',
				'edit', 'trash', 'copy', 'info', 'warning', 'error', 'success', 'question',
				'user', 'home', 'cog', 'bell', 'heart', 'star', 'eye', 'eye-off',
				'lock', 'unlock', 'mail', 'calendar', 'clock', 'download', 'upload',
				'link', 'external-link', 'folder', 'document'
			]
		};
	}
});
