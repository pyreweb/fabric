...
export default {
  ...
  computed: {
    headerClasses() {
      const baseClasses = 'w-full flex items-center justify-between gap-3 p-4 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset transition-colors duration-200 cursor-pointer'
      return baseClasses
    },
    iconClasses() {
      const baseClasses = 'transform transition-transform duration-300 text-gray-500'
